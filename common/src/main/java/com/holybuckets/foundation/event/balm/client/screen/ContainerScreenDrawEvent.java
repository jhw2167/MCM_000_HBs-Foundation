...
public abstract class ContainerScreenDrawEvent extends BalmEvent {
    ...
    public ContainerScreenDrawEvent(Screen screen, GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
        this.screen = screen;
    ...
    public static class Background extends ContainerScreenDrawEvent {
        public Background(Screen screen, GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
            super(screen, guiGraphics, mouseX, mouseY);
        }
    }

    public static class Foreground extends ContainerScreenDrawEvent {
        public Foreground(Screen screen, GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
            super(screen, guiGraphics, mouseX, mouseY);
        }
    }
}
